<?php
	...
	$insertSql = "INSERT INTO poster (accountName,class,postId,postDate,picture,title,good,dislike,context) VALUES ('$accountName','$class','$postId','$postDate','$picture','$title','$good','$dislike','$context')";
